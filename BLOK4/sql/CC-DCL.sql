...
SET PASSWORD FOR 'CCAdmin'@'localhost' = PASSWORD('CCAdmin'); 
SET PASSWORD FOR 'CCAdmin'@'127.0.0.1' = PASSWORD('CCAdmin');
SET PASSWORD FOR 'CCAdmin'@'::1' = PASSWORD('CCAdmin');

SET PASSWORD FOR 'Werknemer'@'localhost' = PASSWORD('CCAdmin'); 
SET PASSWORD FOR 'Werknemer'@'127.0.0.1' = PASSWORD('CCAdmin');
SET PASSWORD FOR 'Werknemer'@'::1' = PASSWORD('CCAdmin');

SET PASSWORD FOR 'Klant'@'localhost' = PASSWORD('CCAdmin'); 
SET PASSWORD FOR 'Klant'@'127.0.0.1' = PASSWORD('CCAdmin');
SET PASSWORD FOR 'Klant'@'::1' = PASSWORD('CCAdmin');
