...
<head>
	<meta charset="utf-8" />
	<meta name="description" content="Coronacompleet. Meer informatie over onze producten zoals, mondkapjes, handschoenen, testen en desinfectie">
				...
				<div class="productImages">
					<div class="Product1">
						<a href="desinfectieProduct.php"><img src="../img/product/desinfectie/desinfectie1.jpg"
							...
							<div class="container">
								...
								<p>Hoge kwaliteit desinfectiepomp</p>
							</div>
						</a>
					</div>
					<div class="Product2">
					...
					<div class="Product3">
						<a href="handschoenProduct.php"><img src="../img/product/handschoen/handschoen1.jpeg"
							...
							<div class="container">
								<h3>Handschoen</h3>
								<p>Desinfecterende handschoen</p>
							</div>
						</a>
					</div>
					<div class="Product4">
